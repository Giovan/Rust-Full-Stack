...
1) Test subreddit submitter with real posts. Should make a go version with graw.

Golang

2) Make concurrent requests with go channels for targets. 
4) Make a web project with Golang and bbolt.

Rust 

3) IFPS, read the code and test it.
```
